...
public class TestFifoQueue {
	...
	/** Test@Before a single offer followed by a single peek. */
	@Test
	...
	public final void testPollOfEmpty() {
		assertEquals("Poll of eprivate FifoQueue<String> q1;mpty queue should return null", null, myIntQueue.poll());
	}
